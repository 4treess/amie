            ...
            {board.map((rowArray, rIdx) => 
              rowArray.map((cell, cIdx) => (
                ...
                >
                  ...
                  {cell.visible ? (cell.isMine ? <BombIcon size={20} className={gameStatus === "Victory" ? "text-green-500 fill-green-100": gameStatus === "Blown Up" ? "text-red-500 fill-red-100" : "text-black-500"}/> : <SafeIcon size={20}/>) : '?'}
                </button>
              ))
            )}
          </div>
