          ...
          <form onSubmit={handleAddEvent} className="bg-white w-full max-w-md rounded-[2rem] p-8 shadow-2xl animate-in zoom-in-95">
            ...
            <div className="space-y-4">
              <div className="flex gap-2">
                <input placeholder="Date (February 1)" className="flex-1 p-3 rounded-xl border-rose-200 outline-none" onChange={(e) => setNewEvent({...newEvent, date: e.target.value})} required />
